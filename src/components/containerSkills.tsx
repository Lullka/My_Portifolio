...
function Skills(){    
    const {SetModalStatus, ModalStatus} = useState<boolean>(false);
    const {SetModalTecnology, ModalTecnology} = useState("react");
    ...
    return(
        <SkillsDiv id="habilidades">
            ...
            <Container>
                ...
                <Modal tecnology={ModalTecnology}/>
                {ModalStatus == true ?
                    <></>
                    :
                    <></>
                ...
                <ContainerSkills>
                    ...
                    <ContainerCards>
                        <UlFrontSkills>
                            <LiFrontSkills tabIndex={5} onMouseMove={(e) => hoverCard(e)} style={{"--color": '#61dafb', "--hoverColor": "rgba(97, 218, 251, 0.2)"} as React.CSSProperties}>
                            ...
                            <LiFrontSkills tabIndex={6} onMouseMove={(e) => hoverCard(e)} style={{"--color": 'rgb(0, 255, 140)', "--hoverColor": "rgba(0, 255, 140, 0.2)"} as React.CSSProperties}>
                                <div className="border"></div>
                ...
                <ContainerSkills>
                    ...
                    <ContainerCards>
                        <UlBackSkills>
                            <LiBackSkills tabIndex={7} onMouseMove={(e) => hoverCard(e)} style={{"--hoverColor": "rgba(131, 205, 41, 0.2)"} as React.CSSProperties}>
                                <div className="border"></div>
                            ...
                            <LiBackSkills tabIndex={8} onMouseMove={(e) => hoverCard(e)} style={{"--hoverColor": "rgba(154, 73, 147, 0.2)"} as React.CSSProperties}>
                                <div className="border"></div>
...
const PClickMe = styled.p`
    ...
    font-weight: 500;
    margin-top: 15px;
    background: -webkit-linear-gradient(45deg, rgb(170, 255, 200) 10%, rgb(100, 255, 140) 70%);
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
    text-shadow: 0px 0px 20px rgb(100, 255, 140);
`;
